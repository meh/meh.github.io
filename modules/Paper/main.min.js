...
f.appendChild(d);d.parentNode.replaceChild(f,d);if(d.nodeName=="h1"){c&&b.appendChild(c);c=new Element("div",{"class":"main"})}f=new Element("a",{"class":d.nodeName});Event.observe(f,"click",function(){d.xpath("//a[@name = #{name}]".interpolate({name:this.firstChild.firstChild.nodeValue})).first().scrollTo()})});b.appendChild(c);$("paper").insert(b)},toChapter:function(a,b){for(var e="",c=0;c<b;c++)e+="."+a[c];return e.substr(1)}});
