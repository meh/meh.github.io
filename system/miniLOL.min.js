...
b.responseXML.documentElement.getAttribute("path")||"modules";var d=miniLOL.Document.fix(b.responseXML).xpath("//module").filter(function(g){return g.getAttribute("name")});d.each(function(g,f){c&&miniLOL.content.set("Loading `#{name}`... [#{number}/#{total}]".interpolate({name:g.getAttribute("name"),number:f+1,total:d.length}));miniLOL.module.load(g.getAttribute("name"))||miniLOL.error(true);if(miniLOL.error())throw $break;},this)}},onFailure:function(b){miniLOL.error("Error while loading modules.xml (#{status} - #{statusText})".interpolate(b),
...
});if(miniLOL.error())return false;Event.observe(document,"unload",function(a){Event.fire(document,":finalization",a)});Event.observe(document,":url.change",function(a){a.stopped||(a.memo?miniLOL.go(a.memo):miniLOL.go(miniLOL.config.core.homePage))});Event.observe(document,":go",miniLOL.tmp.fixScroll=function(){miniLOL.theme.content().scrollTo()});miniLOL.config.core.initialization&&eval(miniLOL.config.core.initialization);miniLOL.go(/[#?]./.test(location.href)?location.href.replace(/^.*[#?]/,"#"):
miniLOL.config.core.homePage);Event.observe(document,":refresh",function(){miniLOL.resource.reload("miniLOL.config","miniLOL.pages","miniLOL.menus")});new PeriodicalExecuter(function(){Event.fire(document,":refresh")},miniLOL.config.core.refreshEvery||360);Event.fire(document,":initialized");Event.stopObserving(document,":initialized");miniLOL.initialized=true},error:function(a,c,b){if(miniLOL.error.major)return true;if(Object.isUndefined(a))return Boolean(miniLOL.error.major);if(Object.isBoolean(a))return miniLOL.error.major=
...
m.toString();return false}e.styles=[];h.xpath("/theme/styles/style").each(function(n){e.styles.push(n.getAttribute("name"))});h.xpath("/theme/templates/*").each(function(n){miniLOL.theme.templates[n.nodeName]=Element.toObject(n)},this);miniLOL.theme.template.setDefaults()},onFailure:function(){i="Could not load theme#information."}});if(i){miniLOL.error(i,true);return false}if(d=miniLOL.utils.get("#{path}/template.html".interpolate({path:f,theme:a}),{minified:true}))$(document.body).update(d);else{miniLOL.error("Could not load template.html.",
...
true);return b}Event.fire(document,":menu.change",miniLOL.menus[a])}},enabled:function(){return Boolean(miniLOL.menus["default"])},exists:function(a){return Boolean(miniLOL.menus[a])},parse:function(a,c){c=c||0;var b=miniLOL.theme.templates.menu;if(!b||!a)if(miniLOL.error())return false;var d=true,g="";$A(a.childNodes).each(function(f){switch(f.nodeType){case Node.ELEMENT_NODE:g+=f.nodeName=="menu"?miniLOL.menu.parsers.layer(b,c).menu.interpolate({data:miniLOL.menu.parse(f,c)}):f.nodeName=="item"?
miniLOL.menu.parsers.item(f,b,c):miniLOL.menu.parsers.other(f,b);break;case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:d||(g+=f.nodeValue);d=false;break}});return g.blank()?"":c==0?miniLOL.menu.parsers.layer(b,c).menu.interpolate({data:g}):g},parsers:{layer:function(a,c){var b={menu:"",item:""};if(a){b=Object.extend(b,a.layers["_"+c]||a.layers["default"]||{});if(!b.menu)b.menu="#{data}";if(!b.item)b.item='<a href="#{href}" #{attributes}>#{text}</a> '}return b},item:function(a,c,b){var d=a.cloneNode(true),
g=d.getAttribute("class")||"";d.removeAttribute("class");var f=d.getAttribute("id")||"";d.removeAttribute("id");var i=d.getAttribute("href")||"";d.removeAttribute("href");return miniLOL.menu.parsers.layer(c,b).item.interpolate(Object.extend(Object.fromAttributes(d.attributes),{"class":g,id:f,href:i,attributes:String.fromAttributes(d.attributes),text:Element.getFirstText(a),data:miniLOL.menu.parse(a,b+1)}))},other:function(a,c){if(!a||!c)return"";var b=c[a.nodeName];if(!b)return"";var d={};$A(a.childNodes).each(function(g){if(g.nodeType==
Node.ELEMENT_NODE)d[g.nodeName]=miniLOL.menu.parsers.other(g,c)});d.text=Element.getFirstText(a);return b.interpolate(Object.extend(d,Object.fromAttributes(a.attributes)))}}},page:{get:function(a,c,b){miniLOL.content.set(miniLOL.config.core.loadingMessage);Event.fire(document,":page.get",{name:a,queries:c});var d=miniLOL.pages.data[a],g=c.type;if(!d){miniLOL.content.set("404 - Not Found");return false}if(d.getAttribute("alias")){typeof c[a]!="string"&&delete c[a];delete c.page;if(!c.title&&d.getAttribute("title"))c.title=
d.getAttribute("title").encodeURIComponent();if(c=Object.toQueryString(c))c="&"+c;d=d.getAttribute("alias");if(!d.isURL()&&d.charAt(0)!="#")d="#"+d;return miniLOL.go(d+c)}if(Object.isUndefined(g))g=d.getAttribute("type");if(b){b={};Object.extend(b,miniLOL.config.core);Object.extend(b,c);document.title=(c.title||d.getAttribute("title")||miniLOL.config.core.siteTitle).interpolate(b)}if(miniLOL.pages.cache[a]){g?miniLOL.content.set(miniLOL.resource.get("miniLOL.functions").render(g,miniLOL.pages.cache[a],
c)):miniLOL.content.set(miniLOL.pages.cache[a]);return true}if(b=d.getAttribute("arguments")){b=b.replace(/[ ,]+/g,"&amp;").toQueryParams();for(var f in b)if(c[f]==null)c[f]=b[f]}d=miniLOL.page.parse(d);miniLOL.pages.cache[a]=d;if(g)d=miniLOL.resource.get("miniLOL.functions").render(g,d,c);miniLOL.content.set(d);return true},parse:function(a,c){var b="";$A(a.childNodes).each(function(d){switch(d.nodeType){case Node.ELEMENT_NODE:if(Object.isFunction(miniLOL.page.parsers[d.nodeName]))b+=miniLOL.page.parsers[d.nodeName](d,
c);break;case Node.CDATA_SECTION_NODE:case Node.TEXT_NODE:b+=d.nodeValue;break}});return b},parsers:{list:function(a,c){var b=a.cloneNode(false);c=c||[a];var d=b.getAttribute("before")||c[0].getAttribute("before")||"";b.removeAttribute("before");var g=b.getAttribute("after")||c[0].getAttribute("after")||"";b.removeAttribute("after");var f=b.getAttribute("arguments")||c[0].getAttribute("arguments")||"";b.removeAttribute("arguments");var i=b.getAttribute("type")||c[0].getAttribute("type")||"";b.removeAttribute("type");
...
d||"";l.removeAttribute("before");var r=l.getAttribute("after")||g||"";l.removeAttribute("after");var u=l.getAttribute("domain")||"";l.removeAttribute("domain");var s=l.getAttribute("arguments")||f;l.removeAttribute("arguments");var t=l.getAttribute("menu")||h;l.removeAttribute("menu");var p=l.getAttribute("title")||"";l.removeAttribute("title");var q=m.isURL(),v=l.getAttribute("class")||"";l.removeAttribute("class");var w=l.getAttribute("id")||"";l.removeAttribute("id");if(n||q){m=!q?"data/"+m:m;
...
":page.load",{path:a,queries:c});if(b)document.title=(c.title||miniLOL.config.core.siteTitle).interpolate(Object.extend(Object.extend({},miniLOL.config.core),c));new Ajax.Request("data/#{path}?#{queries}".interpolate({path:a,queries:Object.toQueryString(c)}),{method:"get",onSuccess:function(d){c.type?miniLOL.content.set(miniLOL.resource.get("miniLOL.functions").render(c.type,d.responseText,c)):miniLOL.content.set(d.responseText);Event.fire(document,":page.loaded",d);Event.fire(document,":go",b.getHashFragment())},
onFailure:function(d){miniLOL.content.set("#{status} - #{statusText}".interpolate(d));Event.fire(document,":page.loaded",d)}})}},module:{create:function(a,c){if(!c){miniLOL.error("Like, do I know how this module is done?",true);return false}Event.fire(document,":module.create",{name:a,module:c});c.name=a;c.root="#{path}/#{module}".interpolate({path:miniLOL.module.path,module:a});if(!Object.isArray(c.dependencies))c.dependencies=[];if(!c.type)c.type="active";if(!c.execute)c.execute=new Function;for(var b in c)if(Object.isFunction(c[b]))c[b]=
c[b].bind(c);c.storage=new miniLOL.Storage("module."+a);if(c.initialize)try{if(c.initialize()===false){if(miniLOL.error())return false;throw Error("An error occurred while initializing the module.");}}catch(d){d.fileName="#{root}/#{path}/#{module}/main.js".interpolate({root:miniLOL.path,path:miniLOL.module.path,module:a});throw d;}miniLOL.modules[a]=c;$A(c.aliases).each(function(g){miniLOL.modules[g]=c});document.fire(":module.created",c);return c},execute:function(a,c,b){if(!a){miniLOL.error("What module should be executed?");
return false}if(!miniLOL.module.exists(a)){b&&miniLOL.error("The module `#{name}` is not loaded.".interpolate({name:a}));return false}if(b){miniLOL.content.set(miniLOL.config.core.loadingMessage);b={};Object.extend(b,miniLOL.config.core);Object.extend(b,c);document.title=(c.title||miniLOL.module.get(a).title||miniLOL.config.core.siteTitle).interpolate(b)}c=Object.isArray(c)?c:[c];Event.fire(document,":module.execute",{name:a,arguments:c});var d;try{d=miniLOL.module.get(a).execute.apply(miniLOL.module.get(a),
c)}catch(g){g.fileName="#{root}/#{path}/#{module}/main.js".interpolate({root:miniLOL.path,path:miniLOL.module.path,module:a});miniLOL.error("An error occurred while executing the module `#{name}`\n\n#{file} @ #{line}:\n#{error}".interpolate({name:a,file:g.fileName,line:g.lineNumber,error:g.toString()}),true);return false}Event.fire(document,":module.executed",{name:a,arguments:c,result:d});if(Object.isUndefined(d))d=true;return d},load:function(a){Event.fire(document,":module.load",a);try{miniLOL.utils.require("#{path}/#{module}/main.js".interpolate({path:miniLOL.module.path,
module:a}),{minified:true});if(miniLOL.error())return false;if(!miniLOL.module.exists(a))throw Error("Something went wrong while loading the module `#{name}`.".interpolate({name:a}));Event.fire(document,":module.loaded",a);return true}catch(c){miniLOL.error("An error occurred while loading the module `#{name}`\n\n#{root}/#{file} @ #{line}:\n\n#{error}".interpolate({name:a,root:miniLOL.path,file:c.fileName,line:c.lineNumber,error:c.toString()}),true);return false}},get:function(a){return miniLOL.modules[a]},
exists:function(a){return Boolean(miniLOL.module.get(a))},dependencies:{check:function(){for(var a in miniLOL.modules){var c=miniLOL.module.get(a).dependencies;if(c)for(var b=0;b<c.length;b++)if(!miniLOL.module.get(c[b]))throw{module:a,require:c[b]};}return true},needs:function(a,c,b,d){miniLOL.module.get(a)?c.call(b||window):setTimeout(function(){miniLOL.module.dependencies.needs(a,c,b)},d||10)}}},go:function(a,c){if(!Object.isString(a))return false;if(a.isURL()){a=a.parseURL();if(a.host!=location.host||
!a.path.startsWith(miniLOL.path))location.href=a.full;else a=a.full.replace(RegExp("^.*"+miniLOL.path),"")}else if(a.charAt(0)!="#")a="#"+a;var b=a.toQueryParams(),d=a.match(/#(([^=&]*)&|([^=&]*)$)/),g=false;b.menu&&miniLOL.menu.change(b.menu);if(d){b.page=d[2]||d[3];if(b.page)g=miniLOL.page.get(b.page,b,a);else c||(g=miniLOL.go("#{page}&#{queries}".interpolate({page:miniLOL.config.core.homePage,queries:Object.toQueryString(b)}),true))}else if(b.module)g=miniLOL.module.execute(b.module,b,true);else if(b.page){d=
b.page;delete b.page;miniLOL.page.load(d,b,a)}else g=miniLOL.go(miniLOL.config.core.homePage);g&&Event.fire(document,":go",a.getHashFragment());return g}};
